...
public final class MultiplicationGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<stub.Fichier.MultiplicationRequest,
      stub.Fichier.MultiplicationResponse> getGetMultiplicationTableMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetMultiplicationTable",
      requestType = stub.Fichier.MultiplicationRequest.class,
      responseType = stub.Fichier.MultiplicationResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<stub.Fichier.MultiplicationRequest,
      stub.Fichier.MultiplicationResponse> getGetMultiplicationTableMethod() {
    io.grpc.MethodDescriptor<stub.Fichier.MultiplicationRequest, stub.Fichier.MultiplicationResponse> getGetMultiplicationTableMethod;
      ...
      synchronized (MultiplicationGrpc.class) {
        if ((getGetMultiplicationTableMethod = MultiplicationGrpc.getGetMultiplicationTableMethod) == null) {
          MultiplicationGrpc.getGetMultiplicationTableMethod = getGetMultiplicationTableMethod = 
              io.grpc.MethodDescriptor.<stub.Fichier.MultiplicationRequest, stub.Fichier.MultiplicationResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "Multiplication", "GetMultiplicationTable"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stub.Fichier.MultiplicationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stub.Fichier.MultiplicationResponse.getDefaultInstance()))
  ...
  public static abstract class MultiplicationImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getMultiplicationTable(stub.Fichier.MultiplicationRequest request,
        io.grpc.stub.StreamObserver<stub.Fichier.MultiplicationResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                stub.Fichier.MultiplicationRequest,
                stub.Fichier.MultiplicationResponse>(
  ...
  public static final class MultiplicationBlockingStub extends io.grpc.stub.AbstractStub<MultiplicationBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<stub.Fichier.MultiplicationResponse> getMultiplicationTable(
        stub.Fichier.MultiplicationRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_MULTIPLICATION_TABLE:
          serviceImpl.getMultiplicationTable((stub.Fichier.MultiplicationRequest) request,
              (io.grpc.stub.StreamObserver<stub.Fichier.MultiplicationResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class MultiplicationBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return stub.Fichier.getDescriptor();
    }
